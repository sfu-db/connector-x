...
/*                              test_date       test_timestamp                  test_timestamptz                    test_int2   test_int4       test_int8               test_float4 test_float8     test_numeric    test_bpchar test_char   test_varchar    test_uuid                                   test_time           test_interval               test_json                                                                   test_jsonb                                                                  test_bytea      test_enum               */
INSERT INTO test_types VALUES ( '1970-01-01',   '1970-01-01 00:00:01',          '1970-01-01 00:00:01-00',           0,          0,              -9223372036854775808,   -1.1,       -1.1,           .01,            '👨‍🍳',       'a',        'abcdefghij',   'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11',     '08:12:40',         '1 year 2 months 3 days',   '{"customer": "John Doe", "items": {"product": "Beer", "qty": 6}}',         '{"customer": "John Doe", "items": {"product": "Beer", "qty": 6}}',         '\010',         'happy',        '{}', '{}', '{}', '{true, false}', '{-1, 0, 1}', '{-1, 0, 1123}', '{-9223372036854775808, 9223372036854775807}', 'str_citext', 'A.B.C.D', '*.B.*', 'A & B*',ARRAY['str1','str2'],ARRAY['text1','text2'],'0');
INSERT INTO test_types VALUES ( '2000-02-28',   '2000-02-28 12:00:10',          '2000-02-28 12:00:10-04',           1,          1,              0,                      0.00,       0.0000,         521.34,         'bb',       'ಠ',        '',             'a0ee-bc99-9c0b-4ef8-bb6d-6bb9-bd38-0a11',  '18:30:00',         '2 weeks ago',              '{"customer": "Lily Bush", "items": {"product": "Diaper", "qty": 24}}',     '{"customer": "Lily Bush", "items": {"product": "Diaper", "qty": 24}}',     'Здра́вствуйте', 'very happy',   NULL, NULL, NULL, '{}', '{}', '{}', '{}', '', 'A.B.E', 'A.*', 'A | B','{"0123456789","abcdefghijklmnopqrstuvwxyz","!@#$%^&*()_-+=~`:;<>?/"}','{"0123456789","abcdefghijklmnopqrstuvwxyz","!@#$%^&*()_-+=~`:;<>?/"}','21');
INSERT INTO test_types VALUES ( '2038-01-18',   '2038-01-18 23:59:59',          '2038-01-18 23:59:59+08',           -32768,     -2147483648,    9223372036854775807,    2.123456,   2.12345678901,  '1e-5',         '',         '😃',       '👨‍🍳👨‍🍳👨‍🍳👨',     'A0EEBC99-9C0B-4EF8-BB6D-6BB9BD380A11',     '23:00:10',         '3 months 2 days ago',      '{"customer": "Josh William", "items": {"product": "Toy Car", "qty": 1}}',  '{"customer": "Josh William", "items": {"product": "Toy Car", "qty": 1}}',  '',             'ecstatic',     '{123.123}', '{-1e-307, 1e308}', '{521.34}', '{true}', '{-32768, 32767}', '{-2147483648, 2147483647}', '{0}', 's', 'A', '*', 'A@',ARRAY['','  '],ARRAY['','  '],'someName');
INSERT INTO test_types VALUES ( '1901-12-14',   '1901-12-14 00:00:00.062547',   '1901-12-14 00:00:00.062547-12',    32767,      2147483647,     1,                      -12345.1,   -12345678901.1, -1.123e2,       'ddddd',    '@',        '@',            '{a0eebc999c0b4ef8bb6d6bb9bd380a11}',       '00:00:59.062547',  '1 year 2 months 3 days',   '{}',                                                                       '{}',                                                                       '😜',           'ecstatic',        '{}', '{}', '{}', '{true, false}', '{-1, 0, 1}', '{-1, 0, 1123}', '{-9223372036854775808, 9223372036854775807}', 'str_citext', 'A.B.C.D', '*.B.*', 'A & B*',ARRAY['str1','str2'],ARRAY['text1','text2'],'0');
INSERT INTO test_types VALUES ( NULL,           NULL,                           NULL,                               NULL,       NULL,           NULL,                   NULL,       NULL,           NULL,           NULL,       NULL,       NULL,           NULL,                                       NULL,               NULL,                      NULL,                                                                        NULL,                                                                       NULL,           NULL,           '{-1e-37, 1e37}', '{0.000234, -12.987654321}', '{0.12, 333.33, 22.22}', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,'{}','{}','101203203-1212323-22131235');
