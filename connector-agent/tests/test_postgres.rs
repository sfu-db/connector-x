...
//             Value::Age(22),
//             Value::Id(2),
//          a   Value::Name(String::from("Abhishek")),
...
#[test]
fn test_postgres() {
    let schema = vec![DataType::String, DataType::U64, DataType::String, DataType::U64];
    let queries = vec![
    ...
    assert_eq!(
        ...
        dw.column_view::<String>(0).unwrap()
    );
    assert_eq!(
        array![1,2,3],
        dw.column_view::<u64>(1).unwrap()
    );
    assert_eq!(
    ...
    assert_eq!(
        array![22, 32, 25],
        dw.column_view::<String>(3).unwrap()
    );
}

// #[test]
// fn test_postgres() {
//     let schema = vec![DataType::String,DataType::String];
//     let queries = vec![
