...
impl TypeConversion<DateTime<Utc>, DateTimeWrapperMicro> for ClickHouseArrowStreamTransport {
    fn convert(val: DateTime<Utc>) -> DateTimeWrapperMicro {
        DateTimeWrapperMicro(val)
    }
}

impl TypeConversion<NaiveTime, NaiveTimeWrapperMicro> for ClickHouseArrowStreamTransport {
