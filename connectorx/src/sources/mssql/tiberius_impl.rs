//! Tiberius-backed implementation of the MsSQL source.
//!
//! This is the original, default implementation (Phase 0/1 of the migration
//! plan tracked against sfu-db/connector-x#942). Compiled only when the
//! `src_mssql_tiberius` feature is active.
